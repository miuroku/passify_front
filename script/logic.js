...
const data = {
  predictions: [
    ...
    },
    {
      awareness: [
        {
          title: "Интернет-реклама (система Google ads): для повышения узнаваемости следует использовать следующие виды рекламы: реклама в контекстно-медийной сети Google, кампании Discovery и Performance Max. Таргетинг осуществляется по ключевых словам и интересам пользователей, по сайту.",
          budget: '0.25',
          prediction: 'CTR - 0,8%, CPC - 0,15 руб., CR - 2%'
        },
        {
          title: 'Реклама в социальных сетях: такие платформы, как Facebook и Instagram, могут использоваться для охвата потенциальных клиентов и повышения осведомленности. Таргетинг осуществляется по интересам пользователей и демографическим данным.',
          budget: '0.15',
          prediction: 'CTR - 1,1%, CPC - 0,45 руб., CR - 3%'
        }
      ],
      interest: [
        {
      ...
      desire: [
        {
          title: "Реклама в социальных сетях (система Facebook ads): для работы с горячей аудиторией следует использовать следующие виды рекламы: кампании, направленные на конверсии. Таргетинг осуществляется по интересами и демографическим данным.",
          budget: '0.07',
          prediction: ' CTR - 2,9%, CPC - 0,65 руб., CR - 16%'
        },
        {
          title: 'Рассылки в мессенджерах: позволяют взаимодействовать с лояльной аудиторией, предлагать персонализированную выгоду. Также можно использовать белорусский мессенджер viber для рассылки.',
          budget: '0.03',
          prediction: ''
        }
      ],
      action: [
        {
          title: "Ретаргетинг: Использование перенастройки объявлений для охвата посетителей, которые ранее просматривали страницу сайта, может помочь преобразовать их в клиентов.",
          budget: '0.2',
          prediction: 'CTR - 2,9%, CPC - 0,75 руб., CR - 29%'
        }
      ],
      branching: {
        promotion_goal: "увеличение спроса на товары и услуги",
        sphere: "электроника"
      }
    }
  ]
